_base_ = [
    './bevfusion_lidar_100m_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d.py'
]
# point_cloud_range = [-54.0, -54.0, -5.0, 54.0, 54.0, 3.0]
point_cloud_range = [-50.0, -54.0, -5.0, 150.0, 54.0, 3.0]
...
model = dict(
    ...
    view_transform=dict(
        ...
        # xbound=[-54.0, 154.0, 0.3],
        ybound=[-54.0, 54.0, 0.3],
        zbound=[-10.0, 10.0, 20.0],
        dbound=[1.0, 150.0, 0.5],
        downsample=2),
    fusion_layer=dict(
