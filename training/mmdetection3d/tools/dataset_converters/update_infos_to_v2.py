...
def update_av2_infos(pkl_path, out_dir):
    ...
    for i, ori_info_dict in enumerate(
        mmengine.track_iter_progress(data_list['data_list'])):
        ...
        temp_data_info['lidar_points']['lidar_path'] = Path(
            ori_info_dict['lidar_points']['lidar_path']).name
...
def update_pkl_infos(dataset, out_dir, pkl_path):
    ...
    elif dataset.lower() == 'av2dataset':
        update_av2_infos(pkl_path=pkl_path, out_dir=out_dir)
    else:
