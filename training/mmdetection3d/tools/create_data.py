...
from tools.dataset_converters import av2_converter as av2_converter
...
def av2_data_prep(root_path,
    ...
    create_groundtruth_database(dataset_name, root_path, info_prefix, f'{info_prefix}_infos_val.pkl')
    # GTDatabaseCreater(
    #     dataset_name,
    #     out_dir,
    #     info_prefix,
